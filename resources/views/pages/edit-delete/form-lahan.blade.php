            ...
            <div class="modal-body">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ $lahan->id_lahan }}" class="border border-gray-300 rounded px-3 py-2 w-full">
                    </div>
                    <div class="mb-4">
                        <label for="nama" class="block text-gray-700 font-bold">ID FARMER</label>
                        <input type="text" name="nama" id="nama" value="{{ $lahan->id_user }}" class="border border-gray-300 rounded px-3 py-2 w-full">
                    </div>
                    <div class="mb-4">
                        <label for="email" class="block text-gray-700 font-bold">LUAS LAHAN</label>
                        <input type="text" name="email" id="email" value="{{ $lahan->luas_lahan }}" class="border border-gray-300 rounded px-3 py-2 w-full">
                    </div>
                    <div class="mb-4">
                        <label for="alamat" class="block text-gray-700 font-bold">ALAMAT LAHAN</label>
                        <textarea name="alamat" id="alamat" class="border border-gray-300 rounded px-3 py-4 w-full max-w-full h-20 resize-y">{{ htmlspecialchars($lahan->alamat_lahan) }}</textarea>
                    </div>
